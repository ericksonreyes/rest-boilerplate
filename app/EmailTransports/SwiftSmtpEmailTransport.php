...
namespace App\EmailTransports;

use Rest\Shared\Interfaces\Mailer\EmailAddressInterface;
use Rest\Shared\Interfaces\Mailer\EmailInterface;
use Rest\Shared\Interfaces\Mailer\EmailTransport;
...
class SwiftSmtpEmailTransport implements EmailTransport
{
     ...
     * @param $message
     */
    private function addBccRecipients(EmailInterface $email, $message): void
    {
     ...
     * @param $message
     */
    private function addCcRecipients(EmailInterface $email, $message): void
    {
     ...
     * @param $message
     */
    private function addRecipients(EmailInterface $email, $message): void
    {
     ...
     * @param $message
     */
    private function addReplyTo(EmailInterface $email, $message): void
    {
     ...
     * @param $message
     */
    private function addSender(EmailInterface $email, $message): void
    {
        $message->setFrom(
     ...
     * @param $message
     */
    private function addAttachments(EmailInterface $email, $message): void
    {
